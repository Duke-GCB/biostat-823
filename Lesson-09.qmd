...
![_I_ and _D_ are sometimes referred to as "disjoint common subsumers", i.e., the common subsumers that do not subsume another common subsumer. ](images/Semsim/concept-dag-subAll.svg){fig-align="center"}
...
* _1-SimCos_ is _not_ a proper distance metric (violates the triangle ineqaulity). Need to convert to normalized angle: $D_\theta(C_1,C_2) = \frac{\arccos(SimCos(C_1,C_2))}{\pi}$
